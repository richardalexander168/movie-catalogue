...
const LikeButtonPresenter = {
  async init({ likeButtonContainer, favoriteMovies, movie }) { //metode destructuring parameter javascript
    this._likeButtonContainer = likeButtonContainer;
    this._movie = movie;
    this._favoriteMovies = favoriteMovies; //argumen diberikan testFactories.js untuk this.favoriteMovies
